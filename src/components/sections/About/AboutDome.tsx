...
const AboutDome = memo(function AboutDome() {
  return (
    <div className="relative mx-auto -mt-1 sm:-mt-1 md:-mt-1.5 -mb-6 sm:-mb-10 md:-mb-12 w-full max-w-[340px] xs:max-w-[420px] sm:max-w-[640px] md:max-w-[800px] h-[95px] xs:h-[125px] sm:h-[220px] md:h-[265px] pointer-events-none overflow-visible z-10 about-dome flex justify-center items-center">
      <svg
