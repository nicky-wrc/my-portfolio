...
const socialLinks = [
  ...
  {
    name: "Email",
    url: "mailto:worachat.pa@kkumail.com",
    icon: Mail,
    color: "#30D158",
  },
];
...
export default function Footer() {
  ...
  return (
    <div
      ...
      className="bg-[#0F0E0E] w-full px-3 xs:px-4 sm:px-6 md:px-8 pb-8 pt-4"
    >
      <footer
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(20, 18, 18, 0.65) 0%, rgba(13, 12, 12, 0.95) 100%)",
          backdropFilter: "blur(24px) saturate(180%)",
          WebkitBackdropFilter: "blur(24px) saturate(180%)",
          boxShadow:
            "0 24px 60px rgba(0,0,0,0.85), inset 0 1px 0 0 rgba(255, 255, 255, 0.05)",
        }}
      >
