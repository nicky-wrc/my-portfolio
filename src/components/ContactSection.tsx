...
export default function ContactSection() {
  const entrance = useScrollReveal({ distance: 25, delay: 0.1 });
  const buttonEntrance = useScrollReveal({ distance: 25, delay: 0.2 });
  return (
      ...
      <div className="contact-cta-content">
        ...
        <Link href="/contact" className="group inline-block rounded-full">
          ...
          >
            <span
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 z-0 rounded-full bg-[#0F0E0E]/95 backdrop-blur-xl transition-colors group-hover:bg-[#0F0E0E]"
            />
        ...
        <motion.div {...buttonEntrance} className="contact-social-links">
