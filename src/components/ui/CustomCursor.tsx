...
const getCursorSnapshot = () => window.matchMedia(cursorQuery).matches;
...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const handleMouseOver = (e: MouseEvent) => {
      ...
      const isClickable =
        target.closest(
          'a, button, [role="button"], .cursor-pointer, input[type="submit"], input[type="button"], label',
        ) !== null;
      const isText =
        target.closest(
  ...
  return (
    <>
      <div
        ref={ringRef}
        className="custom-cursor-ring-container"
        aria-hidden="true"
      >
      ...
      <div
        ref={dotRef}
        className="custom-cursor-dot-container"
        aria-hidden="true"
      >
